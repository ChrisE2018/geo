...
public class GeoTriangle extends GeoItem
{
        ...
        if (!a.isDetermined ())
        {
            if (b.isDetermined ())
            {
                if (c.isDetermined ())
                {
                    ...
                    logger.info ("Calculate %s: %s", a.getName (), a.getFormula ());
                }
            }
        }
    }
    ...
    // /**
    // * Return the lower leftmost vertex in a list.
    // *
    // * v1 = lowerLeftVertex (sorted);
    // *
    // * v2 = nextVertex (v1, sorted);
    // *
    // * v3 = nextVertex (v2, sorted);
    // */
    // public GeoVertex lowerLeftVertex (List<GeoVertex> sorted)
    // {
    // GeoVertex result = sorted.get (0);
    // for (final GeoVertex v : sorted)
    // {
    // if (lowerLeft (v.getPosition (), result.getPosition ()))
    // {
    // result = v;
    // }
    // }
    ...
    // /**
    // * Is point a lower left of point b.
    // *
    // * @param a Point to compare.
    // * @param b Point to compare.
    // *
    // * @return True if a is left of b, or if a.x == b.x and a is below b.
    // */
    // public boolean lowerLeft (Point2D.Double a, Point2D.Double b)
    // {
    // return (a.x < b.x) || (a.x == b.x & a.y < b.y);
    // }

    // /**
    // * Return the circular next element of the list after the key.
    // *
    // * @param key The item to search for.
    // * @param sorted The item order.
    // *
    // * @return The item after the key, or the first item in the list if there is no item after the
    // * key. This will return the first item in the list, if the key is missing or last.
    // */
    // public GeoVertex nextVertex (GeoVertex key, List<GeoVertex> sorted)
    // {
    // return sorted.get ((sorted.indexOf (key) + 1) % sorted.size ());
    // }
}
